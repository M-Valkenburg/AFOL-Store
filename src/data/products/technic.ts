...
const technic: Product[] = [
    {
        ...
        description: [
            ...
            comprehensive building instructions.`
        ],
        pieces: 3599,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            steering, front and rear suspension for realistic movement, plus front and rear disc brakes.`,
            `Amazing details capture the spirit of Ducati<br>
            ...
            details that make this model toy so true to the full-size version. And of course, the classic red color scheme is sure to quicken the pulse of any Ducati fan.`
        ],
        pieces: 646,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            building toy for creative play The LEGO Technic universe offers advanced building toys for LEGO fans who are ready for their next building challenge.`
        ],
        pieces: 1077,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            `The beauty is in the details<br>
            ...
            This buildable car set lets you enjoy quality downtime as you bring the beautiful Sián FKP 37 to life. Presented in a luxury box, it includes an exclusive 
    ...
    },
    {
        ...
        description: [
            ...
            `Realistic details and powerful functions<br>
            ...
            display where it's sure to draw many admiring glances.`
        ],
        pieces: 830,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            <br>- just like on the iconic original.`,
            `Faithful detailing<br>
    ...
    },
    {
        ...
        description: [
            ...
            `Enjoy the build; savor the details<br>
            ...
            celebrate your passion for pickups.`
        ],
        pieces: 1379,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            and operate the differential locking. With challenges and achievements in the app, there are so many ways to play.`
        ],
        pieces: 2129,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            `Take control of your bulldozer model<br>
            ...
            lower and tilt the blade or raise and lower the ripper and ladder.`
        ],
        pieces: 3854,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            `A close collaboration between the LEGO Group and McLaren Racing
            ...
            a very special collaboration. Just like the real car, this LEGO Technic version features a V6 cylinder engine with moving pistons, steering, suspension and differential.`,
            `Drive your passion<br>
            ...
            that same focus to recreate your favorite vehicles with LEGO Technic sets, designed for adults and fans of collectible cars.`
        ],
        pieces: 1434,
        released: true,
        theme1: 'technic',
    ...
    },
    {
        ...
        description: [
            ...
            the swash plate to control the pitch of the rotor blades, a cockpit door, passenger sliding doors, plus opening front and rear cowlings.`
        ],
        pieces: 2001,
        released: true,
        theme1: 'technic',
