...
const dc: Product[] = [
    {
        ...
        released: true,
        theme1: 'dc',
        tags: ['superheroes', 'vehicles', 'movies'],
        price: 199.99,
        stock: 3,
        sale: false,
        salePrice: 0,
    ...
    },
    {
        ...
        released: true,
        theme1: 'dc',
        tags: ['superheroes', 'helmets', 'movies'],
        price: 59.99,
        stock: 10,
        sale: false,
        salePrice: 0,
    ...
    },
    {
        ...
        released: true,
        theme1: 'dc',
        tags: ['cars', 'superheroes', 'tv-shows', ],
        price: 34.99,
        stock: 42,
        sale: false,
        salePrice: 0,
    ...
    },
    {
        ...
        released: true,
        theme1: 'dc',
        tags: ['superheroes', 'helmets', 'tv-shows'],
        price: 59.99,
        stock: 12,
        sale: false,
        salePrice: 0,
